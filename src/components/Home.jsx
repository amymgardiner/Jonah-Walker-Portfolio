                ...
                <div className="container flex flex-col items-center justify-center main--body">
                    ...
                    <div className="flex flex-col justify-center py-24 my-8 main--body_videos">
                        <div className="flex flex-row justify-center mb-4 space-x-36 home--videos_title">
                            ...
                            <p className="text-[#BFC0C0] max-w-[40%] home--videos_title-description">In this short film, for Kaldi's Coffee, I take a behind-the-scenes look at the people and vintage machines that bring 'Tis the Season holiday blend to life each year.</p>
                        </div>
